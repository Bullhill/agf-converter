...
string folder = "C:\\Users\\169646\\source\\repos\\Bullhill\\agf-converter\\agf converter\\Fields";
    ...
    if (!Directory.Exists(extractFolder))
    {
        ...
        using (MemoryStream ms = new MemoryStream(encFile))
        {
            using (CryptoStream cs = new CryptoStream(ms, decryptor, CryptoStreamMode.Read))
            {
                ...
                FileStream outputFileStream = File.Create(extractFolder + "\\" + FileFirstName + ".xml");
